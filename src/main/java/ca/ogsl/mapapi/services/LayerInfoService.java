...
public class LayerInfoService {
    ...
    public Response layerInfos(LayerInfo layerInfo) {
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("mapapi");
        EntityManager em = emf.createEntityManager();
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    public Response postMultipleLayerInfos(List<LayerInfo> layerInfos) {
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("mapapi");
        EntityManager em = emf.createEntityManager();
        EntityTransaction et = em.getTransaction();
        et.begin();
    ...
    @DELETE
    @Path("{id}")
    public Response deleteLayerInfoForId(@QueryParam("lang") String lang, @PathParam("id") Integer id) {
        PersistenceManager.setLanguageContext(lang);
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("mapapi");
        EntityManager em = emf.createEntityManager();
        LayerInfo layerInfo;
